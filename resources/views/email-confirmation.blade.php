            ...
            <div class="col-md-8 col-md-offset-2">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <div class="lead">You must first confirm your email before using this feature. An confirmation email was sent when you registered. Please use the form below if you need to request a confirmation email again.</div>
